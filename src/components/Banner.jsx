  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-lg text-accent dark:text-white">
          <strong className="font-semibold">10th Year Anniversary</strong>
          <svg viewBox="0 0 2 2" className="mx-2 inline size-0.5 fill-current" aria-hidden="true">
            <circle cx="1" cy="1" r="1"></circle>
          </svg>
          Join us in celebrating on September 30th at Boynton Yards.
        </p>
        <a
      ...
      <div className="flex flex-1 justify-end">
        <button type="button" className="-m-3 p-3 focus-visible:-outline-offset-4" onClick={handleDismiss}>
