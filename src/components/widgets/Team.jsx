  ...
  return (
    <>
      {props.members.map((member, index) => {
        return (
          <div key={index} className="text-center text-gray-500 dark:text-slate-400">
            {member?.avatar && (
              <img
              ...
              {member?.social?.facebook && (
                <li>
                  <a
                    ...
                    className="text-social-facebook hover:text-gray-900 dark:hover:text-white"
                  >
              ...
              {member?.social?.twitter && (
                <li>
                  <a
                    ...
                    className="text-social-twitter hover:text-gray-900 dark:hover:text-white"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {member?.social?.bluesky && (
                <li>
                  <a
                    ...
                    className="text-social-bluesky hover:text-gray-900 dark:hover:text-white"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
              ...
              {member?.social?.github && (
                <li>
                  <a
                    ...
                    className="text-social-github hover:text-gray-900 dark:hover:text-white"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        fillRule="evenodd"
