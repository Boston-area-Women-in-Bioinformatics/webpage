...
authors:
  ...
  - name: 'Anushka Dongaonkar'
    url: 'hhttps://www.linkedin.com/in/anushka-dongaonkar/'
  ...
  - name: 'Mrunali Thokadiwala'
    url: 'https://www.linkedin.com/in/emrunali/'
  - name: 'Emily Lachtara'
...
Samantha Klasfeld’s Biobank Intro Series now has eight installments published. The series is a practical guide to working with UK Biobank and All of Us. Written for researchers who are new to working with these environments on their respective platforms, it covers cloud hardware, phenotype data, OMOP concepts, and genetic variant extraction. A wrap-up post is planned to close out the series. Start from the beginning here: https://boston-wib.org/series/biobank-intro-series

---

### The Rite of Process

What does it feel like to be a DNA sample moving through a whole genome sequencing pipeline? BWIB contributor Sharvari Narendra reimagines the process from the inside out in this evocative poem. Read it here: https://boston-wib.org/blog/quicktake/wgs-analysis-poem
