...
image: /blog_images/2026-02-02_Talk_UMass_Figures_Dana_Slide5.png
imageAlt: 'A slide from the presentation highlights prefrontal and posterior regions of the brain as possible locations to collect biological data about the content of consciousness.'
hideHeroImage: true
imagePosition: top
authors:
  - name: Dana Moochnick
    link: https://www.linkedin.com/in/dana-moochnick
category: Deep Dive
tags:
...
![A slide from the presentation highlights prefrontal and posterior regions of the brain as possible locations to collect biological data about the content of consciousness.](/blog_images/2026-02-02_Talk_UMass_Figures_Dana_Slide5.png)
...
![Brain MRI scans showing common activation patterns in the midbrain and central thalamus across vision, audition, taste, and touch at four seconds from the onset of a stimulus.](/blog_images/2026-02-02_Talk_UMass_Figures_Dana_Slide8.png)
...
![Top three spatial filters from the Common Spatial Pattern projection matrix used to distinguish EEG patterns between spared consciousness (>75% correct response rate across stimuli) and impaired consciousness (<25% correct response rate) during seizures.](/blog_images/2026-02-02_Talk_UMass_Figures_Dana_Slide11.png)
