...
title: '(Dry) Lab Notebooks: The Importance of Recordkeeping in CompBio'
...
excerpt: 'Alex and Lorena explore LLMs, lab notebooks, and the human side of data science—with insights from Amulya Shastry and Lina Faller.'
category: Podcast
tags:
...
metadata:
  title: '(Dry) Lab Notebooks: The Importance of Recordkeeping in CompBio'
  description: 'Alex and Lorena explore LLMs, lab notebooks, and the human side of data science—with insights from Amulya Shastry and Lina Faller.'
