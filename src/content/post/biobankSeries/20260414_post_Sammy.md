...
image: '/blog_images/biobank1/bucketofblobs.png'
imageAlt: 'A tree ring visualization where each ring is a relevant UKB release'
imageDescription: 'A labeled bucket filled with amorphous blobs, representing how Google Cloud Storage organizes data as flat objects rather than true folders.'
...
metadata:
  title: 'Biobank Intro Series: All of Us Genetic Data'
  description: 'Navigating All of Us genotype data for variant extraction and analysis'
  canonical: https://sklasfeld.netlify.app/blog/biobank-intro-series/08-genotypeallofus/
---
