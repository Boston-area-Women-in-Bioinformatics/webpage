...
export const playlists: Playlist[] = [
  ...
  },
  {
    ...
    going: 13,
    moreinfo: [
      'This event is only open to people identifying as women',
      'Feel free to show up any time between 12 and 2pm',
      'We will sit in the outdoor covered space outside Flour.\n**Please understand that each guest will be paying for a meal and/or beverages of their choice.',
    ],
  },
  {
    title: 'Byte and Bite: Bioinformatics Lunch Meetup',
    ...
    moreinfo: [
      ...
      'If the weather holds, we will sit in the outdoor space close to the fountain (otherwise indoors at the tables near Fooda popup)',
      'Please understand that each guest will be paying for a meal and/or beverages of their choice.',
      'Event Update',
