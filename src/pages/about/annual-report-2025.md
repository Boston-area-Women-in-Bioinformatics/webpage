...
tagline: '2025 Annual Report'
layout: '~/layouts/MarkdownLayout.astro'
---

<div class="not-prose bg-gradient-to-br from-purple-50 to-pink-50 dark:from-slate-800 dark:to-slate-700 border-2 border-purple-200 dark:border-purple-700 rounded-lg p-8 my-8 shadow-lg">
  <nav class="space-y-3">
    <h2 class="text-2xl font-bold text-purple-900 dark:text-purple-200 mb-4">Table of Contents</h2>
    <a href="#chairs-message" class="block text-lg font-semibold text-purple-900 dark:text-purple-200 hover:text-pink-700 dark:hover:text-pink-300 transition-colors duration-200 pl-4 border-l-4 border-transparent hover:border-pink-500 py-1">
      Chairs' Message
    </a>
    <a href="#events-committee" class="block text-lg font-semibold text-purple-900 dark:text-purple-200 hover:text-pink-700 dark:hover:text-pink-300 transition-colors duration-200 pl-4 border-l-4 border-transparent hover:border-pink-500 py-1">
      Events Committee
    </a>
    <a href="#website-committee" class="block text-lg font-semibold text-purple-900 dark:text-purple-200 hover:text-pink-700 dark:hover:text-pink-300 transition-colors duration-200 pl-4 border-l-4 border-transparent hover:border-pink-500 py-1">
      Website Committee
    </a>
    <a href="#advocacy-committee" class="block text-lg font-semibold text-purple-900 dark:text-purple-200 hover:text-pink-700 dark:hover:text-pink-300 transition-colors duration-200 pl-4 border-l-4 border-transparent hover:border-pink-500 py-1">
      Advocacy Committee
    </a>
    <a href="#career-sponsorship-committee" class="block text-lg font-semibold text-purple-900 dark:text-purple-200 hover:text-pink-700 dark:hover:text-pink-300 transition-colors duration-200 pl-4 border-l-4 border-transparent hover:border-pink-500 py-1">
      Career Sponsorship Committee
    </a>
    <a href="#communications-committee" class="block text-lg font-semibold text-purple-900 dark:text-purple-200 hover:text-pink-700 dark:hover:text-pink-300 transition-colors duration-200 pl-4 border-l-4 border-transparent hover:border-pink-500 py-1">
...
<span class="text-purple-700 dark:text-purple-300">Lina Faller, Diveena Becker, Shayna Simonstein, Liyang Diao, Samantha Klasfeld, Isha Parikh, Rachel Utama, Aysheh Alrfooh, Lakshmi Kuttippurathu, Mary Piper, Ozge Tasdemir Yilmaz</span>
...
<span class="text-purple-700 dark:text-purple-300">Amulya Shastry, Katie Hughes</span>
...
<span class="text-purple-700 dark:text-purple-300">Sakina Saif, Shreya Rajasekar, Samantha Klasfeld, Masoome Rezaei and Nishita Kalepalli</span>
